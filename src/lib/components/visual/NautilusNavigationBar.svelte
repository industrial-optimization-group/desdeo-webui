...
<script lang="ts">
   ...
   */
  function updateAspirationLine(chart: echarts.EChartsType, newY: number) {
  ...
  function addNewLine(chart: echarts.EChartsType) {
    ...
    let oldLineComponent = getLineComponent(chart, "oldAspLine");
      ...
      <div>
        ...
        <input
          ...
          on:change={(par) => {
            ...
            updateAspirationLine(chart, newY);
          }}
        />
